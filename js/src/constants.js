...
/**
 * Tree collapse mode constants (v4 CollapseState values)
 * @see https://github.com/bernhard-42/three-cad-viewer
 */
export const COLLAPSE_MODE = {
  LEAVES: -1,       // Smart expand (single leaves collapsed)
  COLLAPSE_ALL: 0,  // All nodes collapsed
  ROOT_ONLY: 1,     // Only root expanded
  EXPAND_ALL: 2,    // All nodes expanded
};
